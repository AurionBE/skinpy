...
from typing import TYPE_CHECKING, AsyncIterable, Sequence
...
class Polygon:
    ...
    async def draw(self, draw: ImageDraw.ImageDraw) -> None:
        draw.polygon(
...
async def get_iso_polys(
    enumerator: AsyncIterable[tuple[R3, FaceId, ImageColor]],
    perspective: Perspective | None = None,
) -> AsyncIterable[Polygon]:
    ...
    async for (x, y, z), face_id, color in enumerator:
